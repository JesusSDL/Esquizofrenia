...
-- -----------------------------------------------------
-- Table `esquizofrenia`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `esquizofrenia`.`user` (
...
CREATE TABLE IF NOT EXISTS `esquizofrenia`.`cliente` (
  ...
  PRIMARY KEY (`id_cliente`, `user_id_user`),
  INDEX `fk_cliente_user1_idx` (`user_id_user` ASC) VISIBLE,
  CONSTRAINT `fk_cliente_user1`
    FOREIGN KEY (`user_id_user`)
    REFERENCES `esquizofrenia`.`user` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `esquizofrenia`.`recepcionista` (
  ...
  `user_id_user` INT NOT NULL,
  PRIMARY KEY (`id_recepcionista`, `user_id_user`),
  INDEX `fk_recepcionista_user1_idx` (`user_id_user` ASC) VISIBLE,
  CONSTRAINT `fk_recepcionista_user1`
    FOREIGN KEY (`user_id_user`)
    REFERENCES `esquizofrenia`.`user` (`id_user`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `esquizofrenia`.`reserva_has_cliente` (
  ...
  CONSTRAINT `fk_reserva_has_cliente_cliente1`
    FOREIGN KEY (`cliente_id_cliente` , `cliente_user_id_user`)
    REFERENCES `esquizofrenia`.`cliente` (`id_cliente` , `user_id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
